...
class TestProductRoutes(TestCase):
    ...
    def test_delete_product(self):
        ...
        test_response = self.client.get(BASE_URL)
        logging.info(test_response.status_code)
    ...
    def test_query_by_name(self):
        ...
        number_same_name = len([product.name for product in products if test_name == product.name])
        ...
        # assert that the length of the data list (i.e., the number of products returned in the response) equal to name_count
        self.assertEqual(number_same_name, len(data))

        # use a for loop to iterate through the products in the data list
        # check if each product's name matches the test_name
        for product in data:
    ...
    def test_query_by_category(self):
        ...
        # assert that the length of the data list (i.e., the number of products returned in the response) is
        # equal to found_count
        self.assertEqual(found_count, len(data))

        # use a for loop to check each product in the data list and verify that all returned products belong
        # to the queried category
        for product in data:
    ...
    def test_query_by_availability(self):
        ...
        logging.debug("Available Products [%d] %s", count_available, available_products)

        # send an HTTP GET request to the URL specified by the BASE_URL variable, along with a query
        # parameter "available" set to true.
        ...
        # is equal to available_count
        self.assertEqual(count_available, len(data))
